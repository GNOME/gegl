...
property_double (x_period, _("Period X"), 128.0)
...
property_double (y_period, _("Period Y"), 128.0)
...
property_double (y_phase, _("Phase Y"), 0.0)
...
property_double (x_offset, _("Offset X"), 0.0)
...
property_double (y_offset, _("Offset Y"), 0.0)
